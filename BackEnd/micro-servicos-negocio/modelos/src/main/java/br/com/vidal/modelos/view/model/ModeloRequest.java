package br.com.vidal.modelos.view.model;
...
public class ModeloRequest {
  ...
  public void setPreco(String precoString) throws ParseException {
    this.preco = nf.parse(precoString).doubleValue();
  }
  ...
  public void setIpva(String ipvaString) throws ParseException {
    this.ipva = nf.parse(ipvaString).doubleValue();
  }
